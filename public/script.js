...
async function exportToPDF(text, index) {
  ...
  title.textContent = 'Ayush Intelligence';
  ...
  footer.innerHTML = 'Generated by Ayush Intelligence • <a href="https://ayushintelligence.web.app" style="color: #6366f1; text-decoration: none; font-weight: 600;">https://ayushintelligence.web.app</a>';
...
async function callModel(model, messages, onChunk) {
  try {
    ...
    const systemMessage = {
      role: 'system',
      content: `You are Ayush Intelligence, a sophisticated AI assistant. 
...
Developer: Ayush Intelligence was built and designed by Ayush Kunkulol, also known as Ayush Devspace. His portfolio is at https://ayush-devspace5.web.app. If anyone asks who created you, who your developer is, or who built Ayush Intelligence, always credit Ayush Kunkulol as your creator and developer.`
    };
    ...
    if (lastUserMsg) {
      try {
        ...
        if (searchResults) {
          searchContext = {
            role: 'system',
            content: `[NATIVE AYUSH INTELLIGENCE SEARCH ENABLED]\n\nToday's Date: ${new Date().toLocaleDateString()}\n\nVerified Real-Time Search Results:\n${searchResults}\n\nINSTRUCTION: You are augmented with Ayush Intelligence's internal web search tool. If the search results are relevant to the user's prompt, use them. If they are irrelevant, ignore them and answer directly.`
          };
